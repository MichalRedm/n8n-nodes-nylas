        ...
        options: [
          {
            name: 'Send Message',
            value: 'sendMessage',
            action: 'Send message an email',
          },
          {
            name: 'List Messages',
            value: 'listMessages',
            action: 'List messages an email',
          },
        ],
        default: 'sendMessage',
      },
        ...
        options: [
          {
            name: 'Create Event',
            value: 'createEvent',
            action: 'Create event a calendar',
          },
          {
            name: 'Delete Event',
            value: 'deleteEvent',
            action: 'Delete event a calendar',
          },
          {
            name: 'List Calendars',
            value: 'listCalendars',
            action: 'List calendars a calendar',
          },
          {
            name: 'List Events',
            value: 'listEvents',
            action: 'List events a calendar',
          },
          {
            name: 'Update Event',
            value: 'updateEvent',
            action: 'Update event a calendar',
          },
        ],
        ...
        options: [
          {
            name: 'List Contacts',
            value: 'listContacts',
            action: 'List contacts a contact',
          },
          {
            name: 'Create Contact',
            value: 'createContact',
            action: 'Create contact a contact',
          },
          {
            name: 'Update Contact',
            value: 'updateContact',
            action: 'Update contact a contact',
          },
          {
            name: 'Delete Contact',
            value: 'deleteContact',
            action: 'Delete contact a contact',
          },
        ],
